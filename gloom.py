	...
	def on_load(self):
		...
		if gloom_prompt == 'help':
			...
			print "\n"
                        print "\t\t|Fuzzing|"
                        print "=" * 40
                        print "tcp_fuzzer :: " + colored("Fuzz Applications via. TCP", 'blue')
                        print "ftp_fuzzer :: " + colored("Fuzz Applications via. FTP", 'blue')
                        print "http_fuzzer :: " + colored("Fuzz Applications via. HTTP", 'blue')
